...
|---|--------|--------|-----------|
| 4.1 | AI: оценка трудоёмкости | 🔲 TODO | P0 |
| 4.2 | AI: декомпозиция требований | 🔲 TODO | P0 |
| 4.3 | Telegram-бот: нотификации | 🔲 TODO | P1 |
| 4.4 | GitLab webhook: автообновление статусов | 🔲 TODO | P1 |
