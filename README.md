...
**TaskTime** — система управления проектами и задачами, созданная AI-агентом на вайб-кодинге.
Полнофункциональный MVP с импортозамещением Jira для российского финансового сектора.

> 🚀 **Разработка через AI.** Архитектуру и код создаёт Claude AI-агент, опираясь на интуицию пользователя. Sprint 3 ✅ | Sprint 4 🔄 (AI-модуль + интеграции)
